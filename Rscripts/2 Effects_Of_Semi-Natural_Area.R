...
# testing the effects of mean semi-natural area on the estimated average relationships between spatial heterogeneity and biodiversity 

dat<- read.csv ("Data/datSemiNaturalArea.csv", header=TRUE, sep=",",na.strings=TRUE)
...
mean(dat$Seminatural_Cover_Mean)
sd(dat$Seminatural_Cover_Mean)
standard_error <- function(x) sd(x) / sqrt(length(x))
x <- c(dat$Seminatural_Cover_Mean) 
standard_error(x) 

# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and animal (i.e. invertebrate and vertebrate without pests) richness 
mod1 <- rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="Richness")&(Animals_Plants=="Animals"), method="REML", test="t", level=95)
summary(mod1)
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and animal (i.e. invertebrate and vertebrate without pests) diversity 
mod2 <- rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="SWDiversity")&(Animals_Plants=="Animals"), method="REML", test="t", level=95)
summary(mod2)
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and animal (i.e. invertebrate and vertebrate without pests) abundance 
mod3 <-  rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="Abundance")&(Animals_Plants=="Animals"), method="REML", test="t", level=95)
summary(mod3)
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and plant biodiversity
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and plant richness 
mod1 <- rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="Richness")&(Animals_Plants=="Plants"), method="REML", test="t", level=95)
summary(mod1)
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and plant diversity 
mod2 <- rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="SWDiversity")&(Animals_Plants=="Plants"), method="REML", test="t", level=95)
summary(mod2)
...
# testing the effects of mean semi-natural area on the relationship between spatial heterogeneity and plant abundance 
mod3 <-  rma.mv(yi, vi, mods = ~ Seminatural_Cover_Mean, random = ~ 1 | Study_ID / Effect_Size_ID, data=dat, subset=(Biodiversity_Category=="Abundance")&(Animals_Plants=="Plants"), method="REML", test="t", level=95)
summary(mod3)
