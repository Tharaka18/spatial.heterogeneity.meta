...
# the effect of spatial heterogeneity (i.e. all crop and landscape heterogeneity components) on pest abundance
...
# the effects of spatial compositional heterogeneity (i.e. crop and landscape compositional heterogeneity components) and spatial configurational heterogeneity (i.e. crop and landscape configurational heterogeneity components) on pest Abundance
...
# intraclass correlation (ICC) of the true effects
# compute the ICC (i.e. estimated correlation of the effects belonging to the same study, or how strong the dependency of true effect coming from the same study, or how strong the correlation of within study  heterogeneity)
round(mod2$sigma2[1] / sum(rob1$sigma2), 4)
...
# the effects of crop compositional heterogeneity, crop configurational heterogeneity, landscape compositional and landscape configurational heterogeneity on pest abundance
...
# the effects of crop heterogeneity (i.e. crop compositional and configurational heterogeneity components) and landscape heterogeneity (i.e. landscape compositional and configurational heterogeneity components) on pest abundance
