...
# the effect of spatial compositional heterogeneity (i.e. crop and landscape compositional heterogeneity components) on pollinator richness
...
# the effect of spatial compositional heterogeneity (i.e. crop and landscape compositional heterogeneity components) on pollinator diversity
table(dat$Scale_Cat)
...
# the effect of spatial compositional heterogeneity (i.e. crop and landscape compositional heterogeneity components) on pollinator abundance
table(dat$Scale_Cat)
...
# the effect of spatial configurational heterogeneity (i.e. crop and landscape configurational heterogeneity components) on pollinator richness
table(dat$Heterogeneity)
...
# the effect of spatial configurational heterogeneity (i.e. crop and landscape configurational heterogeneity components) on pollinator diversity
table(dat$Scale_Cat)
...
# the effect of spatial configurational heterogeneity (i.e. crop and landscape configurational heterogeneity components) on pollinator abundance
table(dat$Scale_Cat)
